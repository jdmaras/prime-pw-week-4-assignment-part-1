...
console.log("Adding those numbers together equals: ", addNumbers(6, 9));
...
let food = ["tacos", "pizza", "bahn mi"];
let food2 = [];
function getLast(array) {
  return array[array.length - 1];
}
console.log("Find last item of array: ", getLast(food));
console.log("Find last item of array: ", getLast(food2));
/// COME BACK TO ME!!!!!!!!
